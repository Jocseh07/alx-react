...
describe('getAllNotificationsByUser', () => {
  ...
  it('should have a correct result array in normalized data', () => {
  ...
  it('should have a correct users entity in normalized data', () => {
    const userId = '5debd764a7c57c7839d722e9';
    const expectedUser = {
      age: 25,
  ...
  it('should have a correct messages entity in normalized data', () => {
  ...
  it('should have a correct notifications entity in normalized data', () => {
